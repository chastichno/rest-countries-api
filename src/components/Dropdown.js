    ...
    render() {
        return (
            <div className="dropdown">
                <button className="dropdown__btn" style={{ backgroundImage: `url(${this.props.theme ? down_light : down_dark})` }}>{this.props.region ? this.props.region : "Filter by Region"}</button>
